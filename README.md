...
当前 AI（特别是大语言模型 LLM）领域可划分为以下九大板块：
...
└── 9. 软件架构          → DDIA、架构模式、Agent 架构、分布式系统设计
```
...
| [09-软件架构](./09-软件架构/) | 架构书单、DDIA 笔记、项目架构复盘 | DDIA, 架构模式, Agent 架构, 分布式设计 |
| [附录-技术报告精读](./附录-技术报告精读/) | Llama 3、DeepSeek-V3、OLMo 3 深度精读 | 全栈工程、MoE+MLA+FP8、完全开源流水线 |
...
| 了解图像/视频生成 | [04-生成模型](./04-生成模型/README.md) |
| 看具体模型技术报告 | [05-开源模型Tech-Report](./05-开源模型Tech-Report/README.md) |
| 要一份阅读清单 | [06-推荐阅读清单](./06-推荐阅读清单.md) |
| 了解语音和音频 AI | [07-语音与音频模型](./07-语音与音频模型/README.md) |
| 了解评估基准和 AI 安全 | [评估基准与方法论](./02-后训练与对齐/评估基准与方法论.md)、[AI安全与对齐](./02-后训练与对齐/AI安全与对齐.md) |
| **零基础不知从哪开始** | [零基础入门指南](./08-学习路线与实战项目/零基础入门指南.md) |
| **学 Agent 开发** | [Agent开发学习路径](./08-学习路线与实战项目/Agent开发学习路径.md) |
| **在自己电脑上跑 AI** | [本地AI体验项目](./08-学习路线与实战项目/本地AI体验项目.md) |
| **修炼架构内功** | [09-软件架构](./09-软件架构/) |
| **深入精读核心论文** | [附录-技术报告精读](./附录-技术报告精读/) |
